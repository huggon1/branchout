...
应用图标以[浅色折带图标](design/branchout-icon-light-master.png)为视觉母版。字体、间距、控件高度和断点在真实 Electron 窗口与交互验证中确定。已有[素材列表与阅读流视觉参考](design/README.md#素材列表与阅读流)仅表达阅读结构，具体内容区段以本文及 UX 规格为准。
