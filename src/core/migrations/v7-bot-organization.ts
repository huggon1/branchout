...
export const BOT_ORGANIZATION_VERSION = 7;

/** Store migration v7. The ordered Store runner owns the transaction/version. */
export function migrateBotOrganizationV7(db: DatabaseSync) {
  db.exec(`
